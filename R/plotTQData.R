...
#' 
#' @description 
#' Plot trade and quote data, trades are marked by black crosses, and quotes are plotted as dark grey boxes denoting the bid-offer spread for all the quotes.
#' 
...
#' @export
plotTQData <- function(tData, qData = NULL, xLim = NULL, ...){
  ...
  rect(qData$DT, qData$BID, qData$DT_END, qData$OFR, border = "darkgray", col = 'darkgray')
  rect(qData$DT, qData$OFR, qData$DT_END, qData$BID, border = "darkgray", col = 'darkgray')
  
  points(tData$DT, tData$PRICE, ylab = "price", pch = "x", xaxs = "i", ylim = yLim, col = "black", ...)
