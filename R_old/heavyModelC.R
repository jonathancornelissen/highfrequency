...
#' @export
# heavyModelNew <- function(data, p = matrix(c(0, 0, 1, 1), ncol = 2), q = matrix(c(1, 0, 0, 1), ncol = 2),
#                           startingvalues = NULL, LB = NULL, UB = NULL, backcast = NULL, compconst = FALSE) {
heavyModelNew <- function(data, p = c(1, 1), q = c(1, 1),
                          startingvalues = NULL, LB = NULL, UB = NULL, backcast = NULL, compconst = FALSE) {
  
  return_eq <- ugarchspec()
  measurement_eq <- ugarchspec()
